...
export class EcommerceComponent implements OnInit {
  ...
  public companiesCount: number = 10;
  public usersCount: number = 50;
  public suppliersCount: number = 20;
  public customersCount: number = 30;
  public pinvoiceCount: number = 15;
  public sinvoiceCount: number = 25;
  // Private
  ...
  public pendingPurchaseInvoiceList: any[] = [
    // Your dummy data for pending purchase invoices
    // Example:
    { invoiceDate: new Date(), invoiceNo: 'INV001', supplierName: 'Supplier 1', totalInclVat: 500, status: 'Draft' },
    // Add more items as needed
  ];

  public suppliersList: any[] = [
    // Your dummy data for top 5 contacts (suppliers)
    // Example:
    { supplierName: 'Supplier A', supplierEmail: 'supplierA@example.com', mobile: '1234567890', website: 'https://www.supplierA.com', invoiceCount: 10 },
    // Add more items as needed
  ];

  public customersList: any[] = [
    // Your dummy data for top 5 customers
    // Example:
    { customerName: 'Customer X', customerEmail: 'customerX@example.com', customerMobile: '9876543210', invoiceCount: 8 },
    // Add more items as needed
  ];
